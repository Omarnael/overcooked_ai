...
from overcooked_ai_py.mdp.layout_generator import EMPTY, COUNTER, LAPTOP_DISPENSER, SOLAR_CELL_DISPENSER, CONSTRUCTION_SITE, CONTAINER_DISPENSER, SERVING_LOC
